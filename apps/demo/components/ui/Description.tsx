...
export default function Description({ activeTab }: { activeTab: number }) {
  ...
  return (
    <div className="bg-white xl:shadow-lg w-full p-4 border-t border-gray-200 xl:absolute xl:w-fit xl:top-32 xl:left-10 xl:border xl:border-gray-100 flex flex-col z-10">
